                        ...
                        <form novalidate id="" role="form" enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("surat_keluar/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="Nomor_surat">Lokasi Surat <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Lokasi_surat" value="<?php echo $data['Lokasi_surat']; ?>" type="text" placeholder="Enter Lokasi Surat" required="" name="Lokasi_surat" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
