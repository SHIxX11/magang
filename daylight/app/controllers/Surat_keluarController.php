...
class Surat_keluarController extends SecureController
{
	...
	function index($fieldname = null, $fieldvalue = null)
	{
		...
		if (!empty($request->search)) {
			...
			$search_condition = "(
				...
				surat_keluar.Lokasi_surat LIKE ? OR 
	...
	function add($formdata = null)
	{
		if ($formdata) {
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("tanggal_surat", "Tujuan_surat", "Nomor_surat", "Lokasi_surat", "perihal", "file_surat");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'tanggal_surat' => 'required',
				'Tujuan_surat' => 'required',
				'Nomor_surat' => 'required',
				'Lokasi_surat' => 'required',
				'perihal' => 'required',
				'file_surat' => 'required',
			);
	...
	function edit($rec_id = null, $formdata = null)
	{
		...
		$tablename = $this->tablename;
		//editable fields
		$fields = $this->fields = array("No_Agenda", "tanggal_surat", "Tujuan_surat", "Nomor_surat", "Lokasi_surat", "perihal", "file_surat");
		if ($formdata) {
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'tanggal_surat' => 'required',
